...
def test_codex_review_impl_posts_requester_and_defaults_cwd(monkeypatch, tmp_path):
    ...
    result = server._codex_review_impl(scope="uncommitted")
...
def test_codex_review_impl_requires_terminal_context(monkeypatch):
    ...
    result = server._codex_review_impl("focus on X")
