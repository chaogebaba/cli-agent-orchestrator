...
class TestAssignSenderIdInjection:
    ...
    def test_assign_appends_sender_id_when_injection_enabled(self, mock_create, _nudge, _cwd):
    ...
    @patch("cli_agent_orchestrator.mcp_server.server._create_terminal")
    def test_assign_no_suffix_when_injection_disabled(self, mock_create, _nudge, _cwd):
    ...
    @patch("cli_agent_orchestrator.mcp_server.server.ENABLE_SENDER_ID_INJECTION", True)
    @patch("cli_agent_orchestrator.mcp_server.server._create_terminal")
    def test_assign_suffix_is_appended_not_prepended(self, mock_create, _nudge, _cwd):
    ...
    @patch("cli_agent_orchestrator.mcp_server.server.ENABLE_SENDER_ID_INJECTION", True)
    @patch("cli_agent_orchestrator.mcp_server.server._create_terminal")
    def test_assign_returns_fast_success_message(self, mock_create, _nudge, _cwd):
    ...
    def test_assign_omitted_model_passes_none(self, mock_create):
        ...
        in, leaving provider-side profile/providers.toml resolution unchanged."""
        from cli_agent_orchestrator.mcp_server.server import _assign_impl
