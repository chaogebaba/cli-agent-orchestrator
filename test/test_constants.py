...
class TestCaoHomeDir:
    ...
    def test_cao_home_dir_honors_override_with_production_default(self):
        """CAO_HOME_DIR overrides the namespace; absence retains the legacy default.

        The env var was CAO_HOME until the 2026-07-27 upstream absorb renamed
        it to upstream's CAO_HOME_DIR; constants.py raises if the old name is
        set without the new one, so a missed rename cannot fail silently.
        """
