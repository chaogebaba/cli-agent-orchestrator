...
mod tests {
    ...
    /// (HANDOFF). That gave **24/18/27 = 69**. A further merge brought 26 fork-only ops (barrier/base/sandbox/seam/messages/mailbox/verify/session lifecycle/etc.); all HIDE by default → **24/18/53 = 95**. F102 added `verify manifest` as one more HIDE maintenance command → **24/18/54 = 96**. Note what the shape of this failure was: every count here was internally
