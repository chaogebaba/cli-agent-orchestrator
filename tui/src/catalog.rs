...
pub(crate) const DISPLAY_ORDER: [CommandId; COMMAND_COUNT] = [
    ...
    CommandId::MailboxList,
    CommandId::MessagesAck,
    CommandId::MessagesList,
    CommandId::MessagesTrace,
    CommandId::Redeploy,
    CommandId::SandboxDown,
    CommandId::SandboxStatus,
    CommandId::SandboxUp,
    CommandId::SeamReset,
...
fn entry(id: CommandId) -> Command {
    match id {
        ...
        CommandId::AgentsStatus => Command {
            id: CommandId::AgentsStatus,
            parent: Some("agents"),
            leaf_name: "status",
            summary: "Show the live agent roster for a session.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
        ...
        CommandId::BarrierCancel => Command {
            ...
            parent: Some("barrier"),
            leaf_name: "cancel",
            summary: "Cancel a dispatch barrier by label.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::BarrierStatus => Command {
            id: CommandId::BarrierStatus,
            parent: Some("barrier"),
            leaf_name: "status",
            summary: "Show status of a dispatch barrier.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::BaseRegister => Command {
            id: CommandId::BaseRegister,
            parent: Some("base"),
            leaf_name: "register",
            summary: "Register stored provider history as a global, source-less base.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::ConfigReconcile => Command {
            id: CommandId::ConfigReconcile,
            parent: Some("config"),
            leaf_name: "reconcile",
            summary: "Seed or reconcile providers.toml and report configuration drift.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        ...
        CommandId::Fold => Command {
            ...
            parent: None,
            leaf_name: "fold",
            summary: "Transactionally edit one UTF-8 Markdown FILE, or check its structure.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        ...
        CommandId::LedgerCheck => Command {
            ...
            parent: Some("ledger"),
            leaf_name: "check",
            summary: "Warn about stale re-entry text and count pending ledger rows.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::MailboxDelete => Command {
            id: CommandId::MailboxDelete,
            parent: Some("mailbox"),
            leaf_name: "delete",
            summary: "Delete a mailbox entry.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::MailboxList => Command {
            id: CommandId::MailboxList,
            parent: Some("mailbox"),
            leaf_name: "list",
        ...
        CommandId::MessagesAck => Command {
            id: CommandId::MessagesAck,
            parent: Some("messages"),
            leaf_name: "ack",
            summary: "Advance this supervisor's durable consumption cursor.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::MessagesList => Command {
            id: CommandId::MessagesList,
            parent: Some("messages"),
            leaf_name: "list",
            summary: "List durable inbox messages in ascending id order.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::MessagesTrace => Command {
            id: CommandId::MessagesTrace,
            parent: Some("messages"),
            leaf_name: "trace",
            summary: "Trace durable message delivery.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::Redeploy => Command {
            id: CommandId::Redeploy,
            parent: None,
            leaf_name: "redeploy",
            summary: "Reinstall CAO, optionally restart its server, then verify deployment.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SandboxDown => Command {
            id: CommandId::SandboxDown,
            parent: Some("sandbox"),
            leaf_name: "down",
            summary: "Tear down a G7 sandbox instance.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SandboxStatus => Command {
            id: CommandId::SandboxStatus,
            parent: Some("sandbox"),
            leaf_name: "status",
            summary: "Show G7 sandbox status.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SandboxUp => Command {
            id: CommandId::SandboxUp,
            parent: Some("sandbox"),
            leaf_name: "up",
            summary: "Bring up a G7 sandbox instance.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SeamReset => Command {
            id: CommandId::SeamReset,
            parent: Some("seam"),
            leaf_name: "reset",
            summary: "Reset a seam-parity state.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SeamRollback => Command {
            id: CommandId::SeamRollback,
            parent: Some("seam"),
            leaf_name: "rollback",
            summary: "Roll back a seam-parity state.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SeamStatus => Command {
            id: CommandId::SeamStatus,
            parent: Some("seam"),
            leaf_name: "status",
            summary: "Show seam-parity status.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        ...
        CommandId::SessionClose => Command {
            ...
            parent: Some("session"),
            leaf_name: "close",
            summary: "Close a session and mechanically settle bases and warm intents.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SessionManifest => Command {
            id: CommandId::SessionManifest,
            parent: Some("session"),
            leaf_name: "manifest",
            summary: "Print the canonical session manifest or its compact Markdown brief.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SessionRecover => Command {
            id: CommandId::SessionRecover,
            parent: Some("session"),
            leaf_name: "recover",
            summary: "Explicitly rebind provider sessions after authentication changes.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::SessionStart => Command {
            id: CommandId::SessionStart,
            parent: Some("session"),
            leaf_name: "start",
            summary: "Start a CAO session through the canonical lifecycle API.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::Suite => Command {
            id: CommandId::Suite,
            parent: None,
            leaf_name: "suite",
            summary: "Run the full suite and atomically record a stamped FEATURE log.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::VerifyDeploy => Command {
            id: CommandId::VerifyDeploy,
            parent: Some("verify"),
            leaf_name: "deploy",
            summary: "Compare the installed CLI and running server with this working tree.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        ...
        CommandId::VerifyManifest => Command {
            id: CommandId::VerifyManifest,
            parent: Some("verify"),
            leaf_name: "manifest",
            summary: "Maintain the receiver-state trace manifest.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        ...
        CommandId::VerifyScope => Command {
            ...
            parent: Some("verify"),
            leaf_name: "scope",
            summary: "Require working-tree changes to exactly match FILES.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
        },
        CommandId::VerifySuiteLog => Command {
            id: CommandId::VerifySuiteLog,
            parent: Some("verify"),
            leaf_name: "suite-log",
            summary: "Verify a stamped suite log against the current tree.",
            policy: Policy::Hidden,
            params: &[],
            handoff_reason: None,
            // HIDE: fork-only / ops command; unclassified default (project.md)
...
mod tests {
    ...
    /// **24/18/64 = 106** (`agreement` went with the AC10 report, #738).
    #[test]
    fn the_policy_distribution_is_twentyfour_eighteen_sixtyfour() {
        ...
        assert_eq!(hidden, 64, "expected 64 HIDE commands, found {hidden}");
        assert_eq!(
            in_app + handoff + hidden,
            106,
            "the three policy counts must account for all 106 leaf commands of the Click tree"
        );
        ...
        assert_eq!(
            distinct.len(),
            106,
            "DISPLAY_ORDER must list 106 DISTINCT commands; a duplicate would let one command go \
    ...
    /// counted; and its `distinct.len() == 98` assertion detects a **duplicate**, which is the
        ...
        fn every_id() -> Vec<CommandId> {
            ...
            fn identity(id: CommandId) -> CommandId {
                match id {
                    ...
                    CommandId::MailboxList => CommandId::MailboxList,
                    CommandId::MessagesAck => CommandId::MessagesAck,
                    CommandId::MessagesList => CommandId::MessagesList,
                    CommandId::MessagesTrace => CommandId::MessagesTrace,
                    CommandId::Redeploy => CommandId::Redeploy,
                    CommandId::SandboxDown => CommandId::SandboxDown,
                    CommandId::SandboxStatus => CommandId::SandboxStatus,
                    CommandId::SandboxUp => CommandId::SandboxUp,
                    ...
                    CommandId::VerifyManifest => CommandId::VerifyManifest,
