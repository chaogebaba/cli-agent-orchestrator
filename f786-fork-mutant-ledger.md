...
| 9 | profile-less fallback restored at terminal_service (`profile=None` instead of raise) | terminal_service.create_terminal (load block) | test_f786_composed_and_routing.py::TestAC8ComposedStore::test_missing_composed_name_fails_closed |
